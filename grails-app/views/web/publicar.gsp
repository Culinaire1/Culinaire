        ...
        <div class="row">
            <div class="center-block ing" style="width:80%">
                <g:form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                font-size: 20px; margin-top: 2px;" >Agregar</button>
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <input type="submit" class="btn btn-primary btn-lg center-block botones b2" style="margin-right: 2%" value="Publicar">
                </g:form>
            </div>
        </div>
        <br>
