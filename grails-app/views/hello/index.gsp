...
<head>
    ...
    <title>Inicio</title>
    <link rel="icon" type="image/png" href="../../../web-app/images/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="../../../web-app/images/favicon-16x16.png" sizes="16x16" />
    ...
    <style>
    @font-face { font-family: Abraham; src: url('../../../web-app/fonts/AbrahamLincoln.ttf'); }
    @font-face { font-family: Cylburn; src: url('../../../web-app/fonts/Cylburn.ttf'); }
    @font-face { font-family: GearedSlab; src: url('../../../web-app/fonts/GearedSlab.ttf'); }
    @font-face { font-family: GrandHotel; src: url('../../../web-app/fonts/GrandHotel-Regular.otf'); }
    @font-face { font-family: Liberator; src: url('../../../web-app/fonts/Liberator-Light.ttf'); }
    </style>
</head>
<body>
    ...
    <nav>
        ...
        <div id="navbar" class="navbar-collapse collapse lista">
            <ul class="nav nav-justified ">
                <li><a href="index.gsp" role="button">Inicio</a></li>
                <li class="dropdown active"><a href="busqueda" class="dropdown-toggle">Búsqueda</a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Restaurantes</a></li>
                        <li><a href="#">Platos típicos</a></li>
                    </ul>
                </li>
                <li class="dropdown active"><a href="categorias" class="dropdown-toggle">Categorías</a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown active"><a href="favoritos" class="dropdown-toggle">Favoritos</a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Recetas</a></li>
                        <li><a href="#">Usuarios</a></li>
                    </ul>
                </li>
                <li class="dropdown active"><a href="perfil" class="dropdown-toggle">Acceder</a>
                    <ul class="dropdown-menu">
